...
<div class="layui-container fly-marginTop">
    <div class="fly-panel" pad20="" style="padding-top: 5px;">
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            ...
            <form id="form" action="${pageContext.request.contextPath }/cart/newCart.html" method="post" enctype="multipart/form-data">
                <!-- 富文本编辑器内容 -->
                ...
                <div class="layui-form layui-form-pane" style="padding: 20px 0;">
                    ...
                    <c:if test="${sessionScope.user.flag == 2 }">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select id="select3" class="select2" name="flag">
                    ...
                    <div class="layui-form-item">
                        <button class="layui-btn" id="submitButton" onclick="formSubmit();">立即发布</button>
                    </div>
