    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md8">
            ...
            <div class="fly-panel">
                ...
                <ul class="fly-list">
                    <c:forEach items="${noticeList }" var="cart">
                        <li>
                            <a href="${pageContext.request.contextPath }/homepage${cart.user.id }.html" class="fly-avatar">
                                <img src="${pageContext.request.contextPath}${cart.user.image }" alt="yeah"></a>
                            <h2>
                                <a class="layui-badge">通知公告</a>
                                <a href="${pageContext.request.contextPath }/cart/${cart.cartId }.html">${cart.title }</a></h2>
                    ...
                    <i class="layui-icon" title="查看">&#xe705;</i>${cart.readnum }</span>
                            ...
                            <div class="fly-list-badge"> <span class="layui-badge layui-bg-red">通知</span> </div>
                        </li>
                    ...
                    <c:forEach items="${pageBean.list }" var="cart">
                        ...
                        <li><a href="${pageContext.request.contextPath }/homepage${cart.user.id }.html"
                               class="fly-avatar"> <img
                                src="${pageContext.request.contextPath}${cart.user.image }" alt="${cart.user.niko }">
                        </a>
                            <h2>
