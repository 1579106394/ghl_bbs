    ...
    <div class="fly-panel fly-panel-user" pad20="">
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            ...
            <div class="layui-tab-content" style="padding: 20px 0;">
                <div class="layui-form layui-form-pane layui-tab-item layui-show">
                    <form id="baseForm" action="${pageContext.request.contextPath }/user/updateBase.html" method="post">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input name="niko" title="4-10个字节" required="" lay-verify="required"
                                           value="${user.niko }" class="layui-input" type="text">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="L_city" class="layui-form-label">手机号</label>
                                <div class="layui-input-inline">
                                    <input name="telephone" disabled value="${user.telephone }" class="layui-input"
                                           type="text">
                                </div>
                            </div>
                            <label for="L_email" class="layui-form-label">邮箱</label>
                            <div class="layui-input-inline">
                                <input id="L_email" name="email" disabled autocomplete="off" value="${user.email }"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input id="L_city" name="clazz" value="${user.clazz }" autocomplete="off"
                                       class="layui-input" type="text">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="随便写些什么刷下存在感" id="L_sign" name="autograph" autocomplete="off"
                                          class="layui-textarea" style="height: 80px;">${user.autograph }</textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <button onclick="commitBase();" class="layui-btn" key="set-mine" lay-filter="user_set">修改
                            </button>
                        </div>
                    ...
                    <form method="post">
                        <div class="layui-form-item">
                            <div class="avatar-add">
                                ...
                                <button id="image" type="button" class="layui-btn upload-img"><i
                                        class="layui-icon"></i>上传头像
                                </button>
                                <input name="image" value="" class="layui-input" type="hidden">
                                <img id="touxiang" src="${pageContext.request.contextPath}${user.image }">
                            </div>
                        </div>
                        <div class="layui-form-item">
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <form id="passForm" action="${pageContext.request.contextPath }/user/updatePass.html"
