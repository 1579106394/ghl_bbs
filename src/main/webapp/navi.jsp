    ...
    $(function () {
        $.ajax({
            ...
            success: function (dep) {
                ...
                $(".ul1").append("<li id='0' ><a href='${pageContext.request.contextPath}'>首页</a> </li>")
                ...
                $(".ul1").append("<li id='80'><a href='${pageContext.request.contextPath}/file/userFileList.html'>文件下载</a> </li>")
