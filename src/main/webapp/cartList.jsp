                    ...
                    <c:forEach items="${pageBean.list }" var="cart">
                        ...
                        <li><a href="${pageContext.request.contextPath }/homepage${cart.user.id }.html"
                            ...
                            <div class="fly-list-info">
                                    ...
                                    </span> <span class="fly-list-nums"> <i class="layui-icon"
                                                                            title="查看">&#xe705;</i>${cart.readnum }
									</span>
                            </div>
                        </li>
                ...
                <div style="border-top: 1px dotted #e2e2e2; text-align: center;">
                    <ul class="pagination">
                        ...
                        <c:forEach begin="1" end="${end }" var="page">
                            ...
                            <c:if test="${pageBean.currentPage != page }">
                                <li><a
                                        href="${pageContext.request.contextPath }/cart/cartList.html?currentPage=${page }&orderBy=${orderBy }&typeId=${typeId}">${page }</a>
                                </li>
                            </c:if>
                        </c:forEach>
